// Ported from RikkaApps/Shizuku (manager/src/main/jni/adb_pairing.cpp),
// licensed under Apache License 2.0. See THIRD_PARTY_NOTICES.md.
// Adapted: JNI_OnLoad registers against com/mttd/data/adb/PairingContext instead of
// moe/shizuku/manager/adb/PairingContext, matching this project's ported Kotlin package.
// stdint.h must come before jni.h: this NDK's jni.h uses uint8_t/int32_t/etc. without
// including it itself, and <cstdint> alone doesn't put those names in the global namespace
// here (unlike the AOSP tree Shizuku's own CMakeLists targets).
#include <stdint.h>
#include <cinttypes>
#include <jni.h>
#include <dirent.h>
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    env->RegisterNatives(env->FindClass("com/mttd/data/adb/PairingContext"), methods_PairingContext,
